...
void init_audio() {
    ...
    // Cargar música
    bg_music = Mix_LoadMUS("audio_files/Barotrauma OST_ Embrace the Abyss (Menu Theme).mp3");
    if (!bg_music) {
...
void menu() {
    ...
    Fl_JPEG_Image* nauti_menu3 = new Fl_JPEG_Image("gui_textures/nauti_menu3.jpg");
    ...
    Fl_JPEG_Image* play_button1 = new Fl_JPEG_Image("gui_textures/play_button.jpg");
    ...
    Fl_JPEG_Image* quit_button1 = new Fl_JPEG_Image("gui_textures/quit_button.jpg");
...
void board() {
    ...
    //imagen del mapa
    Fl_JPEG_Image* nauti_map1 = new Fl_JPEG_Image("gui_textures/nauti_map1.jpg");
    ...
    //submarino de prueba
    Fl_PNG_Image* selkie_px800 = new Fl_PNG_Image("gui_textures/800px-Selkie.png");
